...
<section class="films" id="films-section">
    <p style="text-align: center;margin: auto;margin-top: 20pt; margin-bottom: 10pt;border-bottom: 2px solid white; width: fit-content;">
        Click on film to add to favourites, click again to remove.</p>
    <ul id="movie-list"></ul>
</section>
