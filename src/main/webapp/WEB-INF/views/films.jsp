...
<html lang="en">
    <head>
        ...
        <link
            href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,400;0,600;0,700;1,400&family=Squada+One&display=swap"
            rel="stylesheet"
        />
        <link
            rel="stylesheet"
        ...
        <script src="${pageContext.request.contextPath}/scripts/films.js" defer></script>
